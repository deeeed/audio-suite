...
export class MoonshineService {
  ...
  private readonly intentModelCache = new Map<
    string,
  ...
  >();
  private readonly listeners = new Set<MoonshineListener>();
  private readonly modelCache = new Map<string, MoonshineWebModel>();
